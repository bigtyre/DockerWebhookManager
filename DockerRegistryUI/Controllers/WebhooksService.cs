...
{
    public WebhooksService(WebhookRepository webhookRepository, EventSystem eventSystem)
    {
    ...
    private async Task ExecuteWebhookAsync(Webhook webhook)
    {
        ...
        var args = new WebhookEventArgs(webhookId);
        EventSystem.OnWebhookCalled(this, args);
    }
}
